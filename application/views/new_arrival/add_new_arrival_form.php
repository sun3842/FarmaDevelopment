	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				echo form_open_multipart("NewArrival/create_new_arrival", $attributes);
				?>
					...
					<div class='form-group'>
						...
						<input type='text' class='form-control'   name='new_arrival_product_name_title' placeholder='<?php echo $this->lang->line('title');?>' >
...
<div class='form-group'>
                        ...
                        <textarea class='form-control'    name='new_arrival_product_description'  > </textarea>
						<span class='text-danger'><?php  echo form_error('new_arrival_product_description'); ?></span>
					</div>
					<div class='form-group'>
						<label><?php echo $this->lang->line('status');?></label>
                        <?php echo  form_dropdown('new_arrival_product_is_in_stock', $this->new_arrival_status_array,0,'class="form-control" id=""');?>
						<span class='text-danger'><?php  echo form_error('new_arrival_product_is_in_stock'); ?></span>
					</div>
					<div class='form-group'>
						<label><?php echo $this->lang->line('price');?></label>
                         <?php echo  form_dropdown('new_arrival_product_price', $this->new_arrival_price_array,0,'class="form-control" id="new_arrival_product_price_id"');?>
					</div>
                    <div id="new_arrival_fixed_price_div" class="col-md-offset-1 col-lg-offset-1 col-sm-offset-1" style="display:none;">
					<div class="form-group">
                    ...
                    <div id="new_arrival_range_price_div" class="col-md-offset-1 col-lg-offset-1 col-sm-offset-1" style="display:none;">
					...
					<div class='form-group'>
                        ...
                        <?php echo  form_dropdown('new_arrival_ref_currency_id', $this->new_arrival_currency_array,NULL,'class="form-control" id=""');?>
					...
					<div class='form-group'>
						...
						<input type='text' class='form-control'   name='new_arrival_ending_validation_date' id="new_arrival_ending_validation_date" >
