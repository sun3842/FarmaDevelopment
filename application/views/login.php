	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4" style="margin-top:50px;">
							...
							<ul class="header-notifications " style="padding: 5px">
								<li>
					...
					<div class="panel panel-default">
						<div class="panel-body no-border">
                            ...
                            <!--
                              ...
                              -->
								<button type="submit" class="btn btn-green btn-login pull-right"> <?php echo $this->lang->line('login');?> </button>
							</div>
     ...
     <!-- Modal -->
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
              <div class="modal-dialog">
                  ...
                  <form action="<?php echo site_url('get_reset_password_link');?>" method="post">
