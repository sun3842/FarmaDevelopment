	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div id="our_gallery">
							...
							<?php echo $this->load->view($this->views_folder_name.'/gallery/all_photos_by_album'); ?>
	...
	/*-----		for lazy load of image gallery	-----*/
		...
		var i=0;
         $(window).scroll(function(){
                ...
                $.ajax({
					 type: "GET",
                    url: "<?php echo base_url() ?>gallery/all_photos_by_lazy_load/?offset="+i+"&album_id="+album_id,
