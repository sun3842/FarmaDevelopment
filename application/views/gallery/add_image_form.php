...
<h1 id="msg" class="text-center text-success"></h1>
	<form id="fileupload" action="#" method="POST" enctype="multipart/form-data"   >
						<div class="form-group">
								...
								<input type="text" class="form-control" name="image_album_name" id="album_name" placeholder="<?php echo  $this->lang->line('album_name'); ?>">
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="3" name="image_album_description" id="album_description" placeholder="<?php echo  $this->lang->line('album_desc'); ?>"></textarea>
							...
							<div class="form-group">
								<div class="row fileupload-buttonbar">
									<div class="col-lg-7">
										...
										<span><?php echo  $this->lang->line('create_album'); ?></span>
										</button>										
									</div>
								</div>
							</div>
	...
	$(document).ready(function()
	{
		...
		/*	ajax form validation and submit		*/
			...
			$("#fileupload").submit(function() {
				...
				var url = "<?php echo base_url() ?>gallery/create_album_ajax"; // the script where you handle the form input.
				...
				$.ajax({
					   ...
					   success: function(data)
					   {
						 ...
						 $("#msg").html("<?php echo  $this->lang->line('album_created_success'); ?>");
