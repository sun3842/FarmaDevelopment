...
$route['app_near_by_pharmacy']="App/search_near_by_pharmacy";

$route['app_product_list']="App/app_product_list";

$route['app_product_list_by_limit/(:any)/(:any)']="App/app_product_list_by_limit/$1/$2";
$route['app_category_product_list_by_limit/(:any)/(:any)/(:any)']="App/app_category_product_list_by_limit/$1/$2/$3";
$route['app_search_product/(:any)']="App/app_search_products_by_app_user_id/$1";

$route['app_all_offer_pdf_list/(:any)']="App/app_all_offer_pdf_list/$1";
$route['app_offer_pdf_products/(:any)']="App/app_offer_pdf_products/$1";
$route['app_all_offer_products/(:any)']="App/app_all_offer_products/$1";
$route['app_category_offer_products/(:any)/(:any)']="App/app_category_offer_products/$1/$2";
$route['app_search_offer_product/(:any)']="App/app_search_offer_products/$1";
...
$route['app_get_pharmacy_details_by_app_user_id/(:any)']="App/app_get_pharmacy_details_by_app_user_id/$1";

$route['app_pharmacist_list/(:any)']="App/app_pharmacist_list/$1";
...
$route['about_pharmacy/(:any)']="Pharmacy/about_pharmacy/$1";
$route['edit_pharmacy/(:any)']="Pharmacy/edit_pharmacy/$1";
